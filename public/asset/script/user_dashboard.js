$(document).ready(function () {
    ...
    $(".dashboardBannersSideA").addClass("activeLi");
    ...
    $("#bannerTable").dataTable({
        ...
        ajax: {
            url: `${domainUrl}fetchDashboardBanners`,
            data: function (data) {
            },
            error: (error) => {
                console.log(error);
        ...
        swal({
            ...
            if (isConfirm) {
                if (user_type == "1") {
                    ...
                    var url = `${domainUrl}deleteDashboardBanners` + "/" + id;
    ...
    $("#addBannerForm").on("submit", function (event) {
        ...
        if (this.checkValidity()) {
            ...
            if (user_type == "1") {
                ...
                $.ajax({
                    url: `${domainUrl}addDashboardBanners`,
                    type: "POST",
                    data: formdata,
                    dataType: "json",
                    contentType: false,
        ...
        $(this).find("select").each(function () {
         ...
         if (this.checkValidity()) {
            ...
            if (user_type == "1") {
                ...
                $.ajax({
                    url: `${domainUrl}editDashboardBanners`,
                    type: "POST",
                    data: formdata,
                    dataType: "json",
                    contentType: false,
