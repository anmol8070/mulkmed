$(document).ready(function () {
    ...
    $(".HospitalProceduresSideA").addClass("activeLi");
    ...
    $("#THP").dataTable({
        ...
        ajax: {
            url: `${domainUrl}smo/fetchHospitalProcedures`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
        ...
        swal({
            ...
            if (isConfirm) {
                if (user_type == "1") {
                    ...
                    var url = `${domainUrl}smo/deleteHospitalProcedures` + "/" + id;
    ...
    $("#addCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/addHospitalProcedures`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
    ...
    $("#editCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/editHospitalProcedures`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
    ...
    $("#THP").on("click", ".edit", function (event) {
        ...
        var edit_market_price = $(this).data("market_price");
        var edit_mulk_price = $(this).data("mulk_price");

        $("#editCatId").val(id);
        $("#editCatProcedure").val(procedure);
        $("#edit_market_price").val(edit_market_price);
        $("#edit_mulk_price").val(edit_mulk_price);
