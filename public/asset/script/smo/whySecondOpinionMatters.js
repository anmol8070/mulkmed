$(document).ready(function () {
    ...
    $(".WhySecondOpinionMattersSideA").addClass("activeLi");
    ...
    $("#THP").dataTable({
        ...
        ajax: {
            url: `${domainUrl}smo/fetchWhySecondOpinionMatters`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
        ...
        swal({
            ...
            if (isConfirm) {
                if (user_type == "1") {
                    ...
                    var url = `${domainUrl}smo/deleteWhySecondOpinionMatters` + "/" + id;
    ...
    $("#addCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/addWhySecondOpinionMatters`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
    ...
    $("#editCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/editWhySecondOpinionMatters`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
