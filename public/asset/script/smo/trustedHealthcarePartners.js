$(document).ready(function () {
    ...
    $(".TrustedHealthcareProvidersSideA").addClass("activeLi");
    ...
    $("#THP").dataTable({
        ...
        ajax: {
            url: `${domainUrl}smo/fetchTrustedHealthcarePartners`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
        ...
        swal({
            ...
            if (isConfirm) {
                if (user_type == "1") {
                    ...
                    var url = `${domainUrl}smo/deleteTrustedHealthcarePartners` + "/" + id;
    ...
    $("#addCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/addTrustedHealthcarePartners`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
    ...
    $("#editCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/editTrustedHealthcarePartners`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
