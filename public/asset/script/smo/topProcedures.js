$(document).ready(function () {
    ...
    $(".TopProceduresSideA").addClass("activeLi");
    ...
    $("#THP").dataTable({
        ...
        ajax: {
            url: `${domainUrl}smo/fetchTopProcedures`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
        ...
        swal({
            ...
            if (isConfirm) {
                if (user_type == "1") {
                    ...
                    var url = `${domainUrl}smo/deleteTopProcedures` + "/" + id;
    ...
    $("#addCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/addTopProcedures`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
    ...
    $("#editCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}smo/editTopProcedures`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
