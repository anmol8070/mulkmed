$(document).ready(function () {
    ...
    $(".BestOffersPlansSideA").addClass("activeLi");
    ...
    $("#bannerTable").dataTable({
        ...
        ajax: {
            url: `${domainUrl}bestOffers/fetchBestOffersPlans`,
            data: function (data) {
            },
            error: (error) => {
                console.log(error);
...
// }
    ...
    $("#addBannerForm").on("submit", function (event) {
        ...
        if (this.checkValidity()) {
            ...
            // show loader beside button
            $("#formLoaderAdd").removeClass("d-none");
