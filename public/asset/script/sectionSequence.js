$(document).ready(function () {
    ...
    $(".homepageSectionsSideA").addClass("activeLi");
    ...
    $("#categoriesTable").dataTable({
        ...
        ajax: {
            url: `${domainUrl}fetchSectionSequence`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
    ...
    $(document).on('change', '.status_toggle', function () {
        ...
        $.ajax({
            url: `${domainUrl}sequenceStatusUpdate`,  // Your Laravel route
            type: 'POST',
            data: {
                id: id,
                status: status,
