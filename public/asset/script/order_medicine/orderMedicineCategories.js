$(document).ready(function () {
    ...
    $(".orderMedicineCategoriesSideA").addClass("activeLi");
    ...
    $("#categoriesTable").dataTable({
        ...
        ajax: {
            url: `${domainUrl}fetchOrderMedicineCategoriesList`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
        ...
        swal({
            ...
            if (isConfirm) {
                if (user_type == "1") {
                    ...
                    var url = `${domainUrl}deleteOrderMedicineCat` + "/" + id;
    ...
    $("#addCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}addOrderMedicineCat`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
    ...
    $("#editCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}editOrderMedicineCat`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
