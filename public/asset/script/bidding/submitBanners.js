$(document).ready(function () {
    ...
    $(".BidSubmitBannerSideA").addClass("activeLi");
    ...
    $("#THP").dataTable({
        ...
        ajax: {
            url: `${domainUrl}bidding/fetchBiddingSubmitBanners`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
        ...
        swal({
            ...
            if (isConfirm) {
                if (user_type == "1") {
                    ...
                    var url = `${domainUrl}bidding/deleteBiddingSubmitBanners` + "/" + id;
    ...
    $("#addCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}bidding/addBiddingSubmitBanners`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
    ...
    $("#editCatForm").on("submit", function (event) {
        ...
        if (user_type == "1") {
            ...
            $.ajax({
                url: `${domainUrl}bidding/editBiddingSubmitBanners`,
                type: "POST",
                data: formdata,
                dataType: "json",
                contentType: false,
