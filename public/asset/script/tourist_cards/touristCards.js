$(document).ready(function () {
    ...
    $(".TouristCardsSideA").addClass("activeLi");
    ...
    $("#THP").dataTable({
        ...
        ajax: {
            url: `${domainUrl}tourist/fetchTouristCards`,
            data: function (data) {},
            error: (error) => {
                console.log(error);
            },
    ...
    $("#THP").on("click", ".edit", function (event) {
        ...
        var travelling_from_country = $(this).data("travelling_from_country");
        var travelling_from_date = $(this).data("travelling_from_date");
        var visit_visa_validity = $(this).data("visit_visa_validity");
        ...
        $("#travelling_from_country").val(travelling_from_country);
        $("#travelling_from_date").val(travelling_from_date);
        $("#visit_visa_validity").val(visit_visa_validity);

         var docs = $(this).data("passport_document");

    // Clear old docs
    $("#passport_document").empty();
    ...
    ? doc
    : `${domainUrl}storage/app/public/${doc.trim()}`;

            $("#passport_document").append(`
        ...
        $("#passport_document").html('<p class="text-muted mb-0">No documents available</p>');
    }
