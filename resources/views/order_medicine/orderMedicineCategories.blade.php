@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/order_medicine/orderMedicineCategories.js') }}?v=1.2"></script>
@endsection
...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Order Medicine Categories') }}</h4>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editCatForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input accept="image/png, image/jpeg" type="file" id="editImage" name="image" class="form-control">
                         ...
                         <div class="form-group">
                            <label> {{ __('Info') }}</label>
                            <input id="editCatInfo" type="text" name="info" class="form-control" >
                        </div>
                        <div class="form-group">
