@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/online_consultation/specialityWiseDiseases.js') }}?v=1.0"></script>
...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Speciality Wise Diseases') }}</h4>

            <a data-toggle="modal" data-target="#addDiseaseModel" href=""
                class="ml-auto btn btn-primary text-white">{{ __('Add Disease') }}</a>
        </div>
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Diseases') }}<span
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editDiseaseForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input id="editImage" type="file" accept="image/*" name="image" class="form-control">
