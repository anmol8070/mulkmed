                                    ...
                                    <div>
                                        ...
                                        <div class="records-tab-div">
                                            ...
                                            <p class="text-grey">
                                             ...
                                             <p class="text-grey">
                                                {{ __('Missed : ') }}<strong>{{ $todayTotalMissedBookings }}</strong>
                                            </p>
                                        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div>
                                        ...
                                        <div class="records-tab-div">
                                            ...
                                            <p class="text-grey">
                                                {{ __('Missed : ') }}<strong>{{ $last7daysTotalMissedBookings }}</strong>
                                            </p>
                                        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div>
                                        ...
                                        <div class="records-tab-div">
                                            ...
                                            <p class="text-grey">
                                                {{ __('Missed : ') }}<strong>{{ $last30daysTotalMissedBookings }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div>
                                        ...
                                        <div class="records-tab-div">
                                            ...
                                            <p class="text-grey">
                                                {{ __('Missed : ') }}<strong>{{ $last90daysTotalMissedBookings }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="records-tab-div">
                                            ...
                                            <p class="text-grey">
                                             ...
                                             <p class="text-grey">
                                                {{ __('Missed : ') }}<strong>{{ $last180daysTotalMissedBookings }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="records-tab-div">
                                            ...
                                            <p class="text-grey">
                                             ...
                                             <p class="text-grey">
                                                {{ __('Missed : ') }}<strong>{{ $allTimeTotalMissedBookings }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
