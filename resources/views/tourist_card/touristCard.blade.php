@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/tourist_cards/touristCards.js') }}?v=1.2"></script>
@endsection
        ...
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Tourist Cards') }}<span
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editCatForm" autocomplete="off">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input id="passport_number" type="text" name="priority" class="form-control" required>
                        </div> 

                        <div class="form-group">
                            <label>{{ __('Passport Document') }}</label>
                            <div id="passport_document" class="d-flex flex-wrap gap-2"></div>
                        </div>

                       <div class="form-group">
                           <label> {{ __('Travelling From Country') }}</label>
                           <input id="travelling_from_country" type="text" name="priority" class="form-control" required>
                       </div> 

                       <div class="form-group">
                           <label> {{ __('Travelling From Date') }}</label>
                           <input id="travelling_from_date" type="text" name="priority" class="form-control" required>
                       </div> 

                       <div class="form-group">
                           <label> {{ __('Visa Validity') }}</label>
                           <input id="visit_visa_validity" type="text" name="priority" class="form-control" required>
                       </div> 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="addCatForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label> {{ __('Name') }}</label>
                              <select id="addHospitalName" name="hospital_id" class="form-control" required>
                                <option value>{{__('Select Hospital')}}</option>
                            </select>
                            <input type="hidden" id="selectedHospitalTextAdd" name="name">
                        </div>
