@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/smo/MulkmedChoiceOfDoctors.js') }}?v=1.0"></script>
@endsection
...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Mulkmed Choice Of Doctors') }}</h4>
        ...
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Mulkmed Choice Of Doctors') }}<span
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Edit Mulkmed Choice Of Doctors') }}</h5>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label> {{ __('Doctor') }}</label>
                              <select name="doctor_id" id="editDoctorName"  class="form-control"
                                     data-live-search="true" title="Select Doctor">
                            </select>
                             
                            <input type="hidden"  id="selectedDoctorTextEdit" name="name">
                        </div>           
                        <div class="form-group">
                            <label> {{ __('Description') }}</label>
                            <input id="editCatDescription" type="text" name="description" class="form-control" required>
                        </div>           
                        <div class="form-group">
    ...
    <div class="modal fade" id="addCatModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Add Mulkmed Choice Of Doctors') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="addCatForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label> {{ __('Doctor') }}</label>
                            <select id="addDoctorName" name="doctor_id" class="form-control" required>
                                <option value>{{__('Select Doctor')}}</option>
                            </select>
                            <input type="hidden" id="selectedDoctorTextAdd" name="name">
                        </div>
