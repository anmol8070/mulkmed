@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/smo/topHospitals.js') }}?v=1.0"></script>
@endsection
        ...
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Top Hospitals') }}<span
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editCatForm" autocomplete="off">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <select id="editHospitalName" name="hospital_id" class="form-control" required>
                                <option value>{{__('Select Hospital')}}</option>
                            </select>
                            <input type="hidden" id="selectedHospitalTextEdit" name="name">
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <input id="editCatPriority" type="text" name="priority" class="form-control" required>
                        </div> 
