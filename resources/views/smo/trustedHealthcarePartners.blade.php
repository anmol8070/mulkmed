@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/smo/trustedHealthcarePartners.js') }}?v=1.0"></script>
@endsection
...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Trusted Healthcare Providers') }}</h4>

            <a data-toggle="modal" data-target="#addCatModal" href=""
                class="ml-auto btn btn-primary text-white">{{ __('Add Healthcare Providers') }}</a>
        </div>
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Trusted Healthcare Providers') }}<span
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Edit Trusted Healthcare Providers') }}</h5>
    ...
    <div class="modal fade" id="addCatModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Add Trusted Healthcare Providers') }}</h5>
