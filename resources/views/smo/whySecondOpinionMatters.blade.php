@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/smo/whySecondOpinionMatters.js') }}?v=1.0"></script>
@endsection
...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Why Second Opinion Matters') }}</h4>

            <a data-toggle="modal" data-target="#addCatModal" href=""
                class="ml-auto btn btn-primary text-white">{{ __('Add Why Second Opinion Matters') }}</a>
        </div>
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Why Second Opinion Matters') }}<span
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Edit Why Second Opinion Matters') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editCatForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label> {{ __('Info') }}</label>
                            <input id="editCatInfo" type="text" name="info" class="form-control" required>
                        </div>  
                        
                        <div class="form-group">
                            <label> {{ __('URL') }}</label>
                            <input id="editCatUrl" type="text" name="url" class="form-control" required>
                        </div> 
    ...
    <div class="modal fade" id="addCatModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Add Why Second Opinion Matters') }}</h5>
