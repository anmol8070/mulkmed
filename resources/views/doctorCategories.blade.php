@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/doctorCategories.js') }}?v=1.2"></script>
@endsection
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editCatForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input id="editCatKeywords" type="text" name="keywords" class="form-control" required>
                        </div>
                         <div class="form-group">
                            <label> {{ __('Info') }}</label>
