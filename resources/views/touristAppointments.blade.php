@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/touristAppointments.js') }}?v=1.1"></script>
@endsection
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer" href="#missedSection" role="tab"
                        data-toggle="tab">{{ __('Missed') }}
                        <span class="badge badge-transparent "></span></a>
                </li>
            </ul>
            ...
            <div class="tab-content tabs" id="home">
                ...
                {{-- missed --}}
                <div role="tabpanel" class="row tab-pane" id="missedSection">
                    <div class="table-responsive col-12">
                        <table class="table table-striped w-100" id="missedAppointmentTable">
                            <thead>
                                <tr>
                                    <th>{{ __('Appointments Number') }}</th>
                                    <th>{{ __('Tourist') }}</th>
