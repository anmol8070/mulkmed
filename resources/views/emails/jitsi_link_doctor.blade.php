  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
    ...
    <tr>
      <td style="padding: 20px;">
        ...
        <p style="font-size: 16px;">A new appointment has been scheduled with the following patient:</p>

        <h3 style="margin-top: 30px; color: #0080cb;">Appointment Details:</h3>
        <ul style="font-size: 16px; padding-left: 20px;">
          <li><strong>Patient Name:</strong> {{ $patient->username }}.</li>
          <li><strong>Patient Phone-number:</strong> {{ $patient->phone_number }}.</li>
          <li><strong>Patient Email Id:</strong> {{ $patient->email }}.</li>
        ...
        <p style="font-size: 16px;">We have asked patient to complete their AI Vitals and upload supporting documents if any.</p>
