@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/bidding/services.js') }}?v=1.1"></script>
@endsection
...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Bidding Services') }}</h4>

            <a data-toggle="modal" data-target="#addCatModal" href=""
                class="ml-auto btn btn-primary text-white">{{ __('Add Bidding Services') }}</a>
        </div>
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Bidding Services') }}<span
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Edit Bidding Services') }}</h5>
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editCatForm" autocomplete="off">
                        ...
                        <input type="hidden" name="id" id="editCatId">
                         ...
                         <div class="form-group">
                            ...
                            <input id="editCatService" type="text" name="service" class="form-control" required>
                        </div> 
