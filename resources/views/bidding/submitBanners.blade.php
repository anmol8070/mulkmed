@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/bidding/submitBanners.js') }}?v=1.0"></script>
@endsection
...
@section('content')
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Bidding Submit Banner') }}</h4>
        ...
        <div class="card-body">
            <ul class="nav nav-pills border-b mb-3  ml-0">
                ...
                <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section1"
                        aria-controls="home" role="tab" data-toggle="tab">{{ __('Bidding Submit Banner') }}<span
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Edit Bidding Submit Banner') }}</h5>
    ...
    <div class="modal fade" id="addCatModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>{{ __('Add Bidding Submit Banner') }}</h5>
