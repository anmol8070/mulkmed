    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-content">
                <div class="left">www.mulkmed.com</div>
            </div>
        </div>
        <div class="MainDivContainer">
            ...
            <div class="index-container">
                <h3 style="color: #63a163">Where to get care?</h3>

                <table>
                    <thead>
                        <th class="list-item list-item-green">Mulk Med Online Dr. </th>
                        <th class="list-item list-item-orange">Family Physician / Urgent Care Clinic / Minor Injuries Unit</th>
                        <th class="list-item list-item-red">Emergency Services</th>
                    </thead>
                </table>    
                ...
                @php
                    ...
                    if ($percentage < 33.34) {
                        $careVenue = 'Mulk Med Online Dr.';
                        $careVenueColor = '#28a745';
                    } elseif ($percentage < 66.67) {
                        $careVenue = 'Family Physician / Urgent Care Clinic / Minor Injuries Unit';
                        $careVenueColor = '#FFA500';
                    } else {
                        $careVenue = 'Emergency Services';
                        $careVenueColor = 'red';
                    }
                @endphp
                ...
                <table class="" style="margin-top: 10px; width:100%; text-align:center">
                    <thead>
                        <th class="" style="color:{{ $careVenueColor }}; text-align:center">{{ $careVenue }}</th>
                    </thead>
                </table> 
            </div>
            ...
            @if(isset($ranked_differential_diagnoses))
                ...
                <h3 style="color:#63a163; margin-top:0;">Your results</h3>
                            ...
                            <tr style="page-break-inside: avoid; border-top:1px solid #ddd;">
                                <td style="padding:8px 12px; border-bottom:1px solid #ddd;">
                                    ...
                                    @if(isset($rdd['common_diagnosis']) && $rdd['common_diagnosis'] === "true")
                                        <span class="your-result-common">Common</span>
                                    @endif
            ...
            <br>
            <h3 style="color: #63a163;">Where to get care? - Responses</h3>
